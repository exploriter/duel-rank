      ...
      <div class="relative bg-gray-50 rounded-xl p-6 overflow-hidden">
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          ...
          <div class="bg-white border border-gray-200 rounded p-3">
            ...
            <div class="text-gray-600">{{ mostActiveItem?.label || 'None' }} ({{
                mostActiveItem?.totalComparisons || 0
              }})
            </div>
          </div>
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <p class="text-emerald-600 max-w-md mx-auto">
            The comparison network will appear here as you make choices between items. Each item will be a node, and
            your comparisons will be connections between them.
          </p>
        </div>
      </div>
    </div>
