    ...
    <div class="bg-violet-50/30 border border-violet-800/10 rounded-xl p-6">
      <div class="flex items-center justify-between mb-6">
        <div class="flex items-center space-x-3">
          <div
              class="w-10 h-10 bg-gradient-to-br from-violet-100 to-violet-300 ring-1 ring-violet-300 inset-ring inset-ring-white rounded-lg flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="size-6 text-violet-800">
      ...
      <div class="mb-8">
        ...
        <p v-if="newItemLabel.error && newItemLabel.error.value && newItemLabel.error.value.length > 0"
           class="text-sm text-red-600 mt-2 flex items-center space-x-1">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="border-t border-violet-800/10 pt-8">
          <h4 class="font-medium text-gray-800 mb-6 flex items-center space-x-1">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2"
                 stroke="currentColor" class="size-5.5">
              <path stroke-linecap="round" stroke-linejoin="round"
          ...
          <TransitionGroup name="item-list" tag="div" class="space-y-3">
            ...
            >
              <!-- Item Number Badge -->
              <div
                  class="absolute -left-2 -top-2 w-6 h-6 bg-gradient-to-br from-violet-500 to-indigo-600 rounded-full flex items-center justify-center z-10 border border-violet-600 inset-ring inset-ring-white/30">
          ...
          <p v-if="editItemLabel.error && editItemLabel.error.value && editItemLabel.error.value.length > 0"
             class="text-sm text-red-600 mt-3 flex items-center space-x-1">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
      ...
      <div v-else class="pt-2">
        <div class="text-center py-8">
          <div
              class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-violet-100 to-violet-300 ring-1 ring-violet-300 inset-ring inset-ring-white rounded-lg flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="size-8 text-violet-800">
              <path stroke-linecap="round" stroke-linejoin="round"
 ...
 */
const handleImportItems = async (importData: {
  items: string[],
  duplicateAction: 'skip' | 'replace' | 'append',
