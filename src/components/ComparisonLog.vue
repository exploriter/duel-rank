  ...
  <div class="p-6 border border-gray-300 rounded-xl bg-white">
    <div class="flex items-center justify-between mb-4">
      ...
      <div v-if="log.length > 0" class="text-xs text-gray-500">
        {{ getCompletedComparisonsFromLog(log) }}
        {{ getCompletedComparisonsFromLog(log) === 1 ? 'comparison' : 'comparisons' }}
      </div>
    </div>

    <div v-if="log.length > 0"
         class="space-y-4 max-h-84 overflow-y-auto p-4 bg-gray-50 border border-gray-200 border-r-0 rounded-l-lg">
      <div
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-3 flex-1 min-w-0">
            ...
            <div class="flex-shrink-0">
              <div v-if="entry.includes('skipped')"
    ...
    <div v-else
         class="bg-gradient-to-t from-emerald-50 to-gray-50 border border-green-800/20 inset-ring inset-ring-white rounded-lg p-12 text-center">
      <div class="space-y-4">
        <div
            class="w-14 h-14 mx-auto bg-gradient-to-br from-emerald-100 to-green-300 ring-1 ring-emerald-300 inset-ring inset-ring-white rounded-lg flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="size-7 text-emerald-800"
               viewBox="0 0 16 16">
            <path
        ...
        <div>
          ...
          <p class="text-emerald-600 max-w-md mx-auto">
            Your comparison history will appear here as you make choices. Each decision helps build a more accurate
            ranking.
          </p>
        </div>
      </div>
