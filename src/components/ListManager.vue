    ...
    <div class="bg-violet-50/30 border border-violet-800/10 rounded-xl p-6">
          ...
          <div class="flex items-center justify-between">
            ...
            >
              ...
              <div v-if="editingListId === list.id" class="space-y-2">
                ...
                <p v-if="editListName.error && editListName.error.value"
            ...
            <div class="flex items-center space-x-2 ml-4">
              <div class="relative">
                ...
                <!-- Actions Dropdown -->
                <div v-if="showActionsForList === list.id" @click.stop
                     class="absolute right-0 top-full mt-2 w-44 bg-white border border-violet-900/20 rounded-lg shadow-lg z-10">
                  <button
      ...
      <div v-if="showCreateForm" class="border-t border-dashed border-t-violet-800/10 pt-6 mt-6">
        <form @submit.prevent="handleCreateList" class="space-y-3">
          ...
          <p v-if="newListName.error && newListName.error.value && newListName.error.value.length > 0"
             class="text-sm text-red-600 flex items-center space-x-1">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
