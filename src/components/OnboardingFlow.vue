  ...
  <div>
    ...
    <div v-if="!hasLists" class="space-y-8">
      ...
      <div class="max-w-sm mx-auto">
        <div
            class="bg-gradient-to-r from-violet-50 to-violet-100 border border-violet-800/10 rounded-xl p-6 space-y-5 mt-18">
      ...
      <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mt-22">
        <div class="text-center space-y-1">
          <div
              class="w-12 h-12 mx-auto bg-violet-100 ring-1 ring-violet-200 inset-ring inset-ring-white rounded-lg flex items-center justify-center mb-4">
