...
<template>
  <div class="max-w-2xl lg:max-w-5xl xl:max-w-7xl mx-auto p-6 space-y-6 mt-12">
    ...
    <header class="text-center mb-12">
      <h1 class="text-7xl md:text-8xl font-black bg-gradient-to-tl from-slate-800 via-violet-500 to-zinc-400 bg-clip-text text-transparent">
        Duel Rank</h1>
    ...
    <footer class="text-center border-t border-t-violet-800/10 mt-12 py-8">
      <p><a
          class="tracking-tighter font-black text-lg bg-gradient-to-r from-violet-950 via-violet-500 to-zinc-600 bg-clip-text text-transparent opacity-50 hover:opacity-100 transition-opacity animated-gradient"
          href="https://exploriter.com" title="Made by Exploriter" target="_blank">explo<span
          class="font-light">(r|it)</span>er</a></p>
    </footer>
